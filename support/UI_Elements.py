...
class Header:
    ...
    def __init__(self, y: float, title: str, size: int, thickness: float = 2, color: tuple = (180, 180, 180), bold: bool = True):
        ...
        self.size = size
        self.title = title
        self.title_font = pg.font.Font("Assets\LDFArial.ttf", size)
...
class Counter:
    ...
    def __init__(self, x: float, y: float, size: int, value: int = 0, title: str = "", title_size: int = 32, title_placement: str = "u"):
        ...
        self.title = title
        if title != "":
            self.title_font = pg.font.Font("Assets\LDFArial.ttf", title_size)
        ...
        self.font = pg.font.Font("Assets\LDFArial.ttf", size)
...
class Dropdown:
    ...
    def __init__(self, x: float, y: float, width: float, height: float, options: list, title: str = "", title_size: int = 14):
        ...
        self.font = pg.font.Font(
            "Assets\LDFArial.ttf", height - (self.border_thickness * 2))
        self.font_color = (180, 180, 180)
        self.option_renders = []
        ...
        self.title_font = pg.font.Font("Assets\LDFArial.ttf")
...
class Checkmark:
    ...
    def update():
        for c in Checkmark.checkmark_list:
            c.title_font = pg.font.Font("Assets\LDFArial.ttf", size=c.size)
...
class TextField:
    ...
    def __init__(self, x: float, y: float, width: float, height: float, text_size: int, border_thickness: float = 4, title: str = '', title_size: str = 14):
        ...
        self.font_color = (180, 180, 180)
        self.font = pg.font.Font("Assets\LDFArial.ttf", text_size)
